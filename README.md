...
| --- | --- | --- |
| **سوپر ادمین** | نخستین ثبت‌نام عمومی با کد دعوتی (`INVITE_CODE`، پیش‌فرض `soc-noooob`) | همه‌چیز: ساخت ادمین و کاربر، دیدن و پاسخ همه گفت‌وگوها، مدیریت همه حساب‌ها |
...
| متغیر | توضیح |
| --- | --- |
| `INVITE_CODE` | کد دعوتی ثبت‌نام سوپر ادمین (پیش‌فرض `soc-noooob` — حتماً عوض کنید) |
